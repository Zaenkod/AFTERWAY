...
user1 = User.create!(
  first_name: "Nathaly",
  last_name: "Gomez",
  address: "83 rue de Monceau, Paris",
...
user5 = User.create!(
  first_name: "Paul",
  last_name: "Portier",
  address: "16 Rue Léon Frot, Paris",
...
user6 = User.create!(
  first_name: "Cécile",
  last_name: "Veneziani",
  address: "154 BIS Bd Macdonald, Paris",
...
puts "Create 5 event for each bar organized by la N avec toute l'équipe"
5.times do
...
puts "Create 5 event organized by le M avec toute l'équipe sans le P"
5.times do
...
puts "Total : 30 bars, 10 Events et EventsBar, 6 Users"
